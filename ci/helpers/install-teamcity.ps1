...
# docker run --name myteamcity-agent1 `
	...
	# -u 0 `
    # -v c:/teamcity/agent1:/data/teamcity_agent/conf `
	# -v /var/run/docker.sock:/var/run/docker.sock `
    # -v c:/teamcity/data/work:/opt/buildagent/work `
    # -v c:/teamcity/data/temp:/opt/buildagent/temp `
    # -v c:/teamcity/data/tools:/opt/buildagent/tools `
    # -v c:/teamcity/data/plugins:/opt/buildagent/plugins `
    # -v c:/teamcity/data/system:/opt/buildagent/system `
	# --network myteamcity-network `
	# -d `
